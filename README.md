...
| binary | Directory | [preeny](https://github.com/ardus/preeny) | A collection of helpful preloads (compiled for many architectures!). | <!--tool--><!--no-test-->
...
```bash
git clone https://github.com/green-parrot-sec/ctf-tools
cd ctf-tools
...
If you find it useful, star it on github (https://github.com/green-parrot-sec/ctf-tools).
